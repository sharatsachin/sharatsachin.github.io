...
\\( o(g(n)) =\\) { \\(f(n)\\) : for any positive constant \\(c\\), there exists \\(n_0\\) such that \\(0 \le f (n) \le c * g(n)\\) for all \\(n \ge n_0\\) }
...
\\( \omega(g(n)) =\\) { \\(f(n)\\) : for any positive constant \\(c\\), there exists \\(n_0\\) such that \\(0 \le c * g(n) \le f(n)\\) for all \\(n \ge n_0\\) }
